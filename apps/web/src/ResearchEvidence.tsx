...
export function InsufficientSourcesDisclosure({ sources, showEmpty = false }: { sources: InsufficientResearchSource[]; showEmpty?: boolean }) {
  ...
  return <details className="research-details insufficient-sources">
    ...
    <p>这些检索内容供你自行核对，不计入有效证据，也不代表已被路线采用。</p>
